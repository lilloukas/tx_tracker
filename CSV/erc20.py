...
def main():
    ...
    with open("ERC20.csv", "w") as f:
        # Write the column headers
        f.write("Date,From,To,Hash,Value,Gas,GasPrice,NFT Name, NFT ID\n")

        for address in addresses:
            # Set the parameters for the API request to get the transactions for the specified address
            params = {
                "module": "account",
                "action": "tokentx",  # Use the tokennftx action
                "address": address,
            ...
            if response.status_code == 200:
                ...
                for transaction in transactions:
                    ...
                    nft_id = transaction["tokenDecimal"]
                    f.write(f"{date},{from_address},{to_address},{_hash},{value},{gas},{gas_price},{nft_name},{nft_id}\n")
            else:
